...
/*
 * The problem happends both on ZovaWM and dwm.
 *
 * The following error message is generated by most graphical programs:
 * MESA: error: ZINK: vkCreateInstance failed (VK_ERROR_INCOMPATIBLE_DRIVER)
 * glx: failed to create drisw screen
 * failed to load driver: zink
 *
 * As we can see it is most likely related to drivers as it complains about incompatible drivers
*/
